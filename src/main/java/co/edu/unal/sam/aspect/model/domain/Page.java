...
public class Page extends Entity {
    ...
    @Column(name = "name_page", unique = true, nullable = true, length = 300)
    ...
    /**
     * @param descriptionPage the descriptionPage to set
     */
    ...
    /**
     * @param namePage the namePage to set
     */
    ...
    /**
     * @param namePageAll the namePageAll to set
     */
    ...
    /**
     * @param orderPage the orderPage to set
     */
