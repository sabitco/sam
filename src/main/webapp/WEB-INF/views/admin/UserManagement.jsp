...
<div ng-controller="UserAdministratorController as ctrl">
...
<t:admintemplate>	
		...
		<!--Div Wrapper-->
    		<div id="wrapper" style="min-height: 278px;">
        		...
        		<div id="page-wrapper" class="row">
                	...
                	<div class="col-xs-12 col-sm-9 ">
						...
						<jsp:include page="components/userManagement/FormUser.jsp" />					
		            </div>
	           		<div class="col-xs-6 col-sm-3 panel">
						<jsp:include page="components/userManagement/ListRecentUser.jsp" /> 
	            	</div>
	            	<div class="col-lg-12">
						<jsp:include page="components/userManagement/ListUser.jsp" /> 
					</div>
			 		<!-- End Div .col-lg-12 -->
     			</div>       
			...
			<!-- Statement JScript-->
				...
				<!-- Angular Touch Core JavaScript -->
				<script
					src="<c:url value='/static/js/administrator/controller/user_controller.js' />"></script>
